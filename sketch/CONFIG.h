...
constexpr uint16_t PIN_COM_SAIL = 4;
...
constexpr uint16_t pwm_sail_min = ;
constexpr uint16_t pwm_sail_max = ;
...
constexpr uint16_t max_pulse_sail = ;
constexpr uint16_t min_pulse_sail = ;

constexpr uint16_t PIN_WINDSENSOR = A0;
constexpr uint16_t PIN_RUDDER_ADC = A1;
constexpr uint16_t RUDDER_CHANNEL = 13;
constexpr uint16_t SAIL_CHANNEL = 0;
